  ...
  <div class="w-full sm:w-600 h-screen">
    ...
    >
      ...
      <div class="pl-16">
        ...
        >
          Under the Biden-Harris administration, American national security and
          foreign policy will be led by experienced professionals ready to
    ...
    >
      ...
      <div class="pl-16">
        ...
        >
          ...
          <br />
          The work ahead of us will be hard, but I promise you this: I will be a
          President for all Americans — whether you voted for me or not.<br />
          <br />
          I will keep the faith that you have placed in me.
        </p>
