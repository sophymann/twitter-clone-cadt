    ...
    >
      ...
      <nav class="mt-5">
        <NuxtLink
          to="/"
          exact
          class="flex items-center justify-center xl:justify-start text-gray-800 mb-8 transition duration-350 ease-in-out"
        >
        ...
        >
          ...
          <span class="hidden xl:block ml-4 font-bold text-md">About</span>
        </NuxtLink>
